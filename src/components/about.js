        ...
        <div className="about-us">
            ...
            >
                ...
                <div className="max-w-2xl text-center relative z-10 text-white">
                    <h1 className="text-5xl font-bold mb-4">About Gringo Media</h1>
            ...
            <section className="testimonial-section p-8 bg-zinc-950 text-white">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="senja-embed" data-id="56b878a7-fb00-4d5e-96d6-30baffe2388c" data-lazyload="false"></div>
                </div>
            </section>
        </div>
    );
