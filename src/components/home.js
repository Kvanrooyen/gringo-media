...
const LandingPage = () => {
    ...
    return (
        <div className="landing-page">
            ...
            <section id="services-section" className="services-section p-8 bg-zinc-800 text-white">
                <div className="flex flex-wrap justify-around">
                    <div className="max-w-sm mb-4 bg-zinc-900 p-5 rounded shadow-md">
            ...
            <section className="work-section py-16 text-center bg-zinc-900 text-white">
