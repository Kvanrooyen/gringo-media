        ...
        <div className="landing-page">
            ...
            >
                ...
                <div className="max-w-2xl text-center relative z-10">
                    <h1 className="text-4xl font-bold text-white mb-4">Gringo Media</h1>
            ...
            <section id="services-section" className="services-section py-16 bg-gray-100">
                <div className="flex flex-wrap justify-around">
                    <div className="max-w-sm mb-4 bg-white p-5 rounded shadow-md">
                        <h2 className="text-xl font-bold mb-2">Corporate Videos</h2>
                    ...
                    <div className="max-w-sm mb-4 bg-white p-5 rounded shadow-md">
                        <h2 className="text-xl font-bold mb-2">Event Videos</h2>
                    ...
                    <div className="max-w-sm mb-4 bg-white p-5 rounded shadow-md">
                        <h2 className="text-xl font-bold mb-2">Promotional Videos</h2>
            ...
            <section className="work-section py-16 text-center">
                ...
                {/* Add your Vimeo video showcase or carousel here */}
                {/* You can use the VimeoVideo component from the previous example */}
            </section>
        </div>
    );
};
